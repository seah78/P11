class TestPurchasePlaces:
    booking_places_lower_value = {
        "places": "4",
        "competition": "Competition 2",
        "club": "Troisième club",
    }
    booking_places_higher_value = {
        "places": "14",
        "competition": "Competition 2",
        "club": "Premier club",
    }
    booking_places_more_than_12 = {
        "places": "13",
    ...
    booking_places_not_have_enought_points = {
        "places": "4",
        "competition": "Competition 1",
        "club": "Deuxième club",
    }
    ...
    def test_valid_purchase(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
        Test valid purchase
        """
    ...
    def test_purchase_less_than_12(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
    ...
    def test_no_purchase_in_finish_competition(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
    ...
    def test_purchase_in_valid_competition(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
        Test purchase in finish competition
    ...
    def test_purchase_bad_competition(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
        Test purchase in finish competition
    ...
    def test_updating_points_after_purchase(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
    ...
    def test_purchase_not_have_enought_points(
        self, client, mock_clubs, mock_competitions, captured_templates
    ):
        """
        ...
        """
        request = client.post(
            "/purchasePlaces", data=self.booking_places_not_have_enought_points
        )
        data = request.data.decode()
        template, context = self._test_request(request, captured_templates)
        assert template.name == "welcome.html"
